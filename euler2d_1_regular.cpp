    ...
    for(int rk = 0; rk < 3; rk++){
        ...
        for(int i = 5; i < m + 5; i++){
            for(int ng = 0; ng < 5; ng++){
                U[0][i][n+5+ng] = 1.69997;
                U[1][i][n+5+ng] = 2.61934*1.69997;
                U[2][i][n+5+ng] = -0.50632*1.69997;
                U[3][i][n+5+ng] = 1.52819 / (gamma_val -1) + 0.5*1.69997*(2.61934*2.61934 + 0.50632*0.50632);
            }
        }
        for(int i = 5; i < m + 5; i++){
            for(int ng = 0; ng < 5; ng++){
        ...
        for(int j = 5; j < n + 5; j++){
            for(int ng = 0; ng < 5; ng++){
                ...
                U[1][ng][j] = 2.9;
                U[2][ng][j] = 0.0;
                U[3][ng][j] = (1.0/1.4) / (gamma_val -1) + 0.5*2.9*2.9;
            }
        }
        for(int j = 5; j < n + 5; j++){
            for(int ng = 0; ng < 5; ng++){
...
double initialization_u(double x, double y){ return 2.9; }
